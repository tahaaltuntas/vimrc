...
Thanks to [amix](https://github.com/amix/).

There are two versions:

* **Basic**: If you want something small just copy [basic.vim](https://github.com/tahaaltuntas/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a great basic setup
...
The basic version is basically just one file and no plugins. You can check out [basic.vim](https://github.com/tahaaltuntas/vimrc/blob/master/vimrcs/basic.vim).

This is useful to install on remote servers where you don't need many plugins and you don't do many edits.

	git clone git://github.com/tahaaltuntas/vimrc.git ~/.vim_runtime
